...
import com.androidtitan.spotscore.main.data.LoginInteractor;
import com.androidtitan.spotscore.main.data.LoginInteractorImpl;
...
public class LoginPresenterImpl extends BasePresenter<LoginView> implements LoginPresenter,
    ...
    public void onAuthenticationFailure() {
        getMvpView().showLoginFailureSnack(mContext.getResources().getString(R.string.missing_field));
